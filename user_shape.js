// import { domtoimage } from '../../node_modules/dom-to-image/dist/dom-to-image.js';
...
function finishShapeSimple(){
    ...
    domtoimage.toBlob(drawing_board)
    .then(function (blob) {
        // file saver to save to local storage
        // reload image tag to point to that picture
...
drawing_board.addEventListener('mousedown',savePoint)
